...
/* { dg-final { scan-assembler-not "\[\\t \]+l\\.jal\[\\t \]+remote_none1" } } */
...
/* { dg-final { scan-assembler-not "\[\\t \]+l\\.jal\[\\t \]+strong_none1" } } */
...
/* { dg-final { scan-assembler-not "\[\\t \]+l\\.jal\[\\t \]+weak_none1" } } */
...
/* { dg-final { scan-assembler-not "\[\\t \]+l\\.jal\[\\t \]+static_none1" } } */
